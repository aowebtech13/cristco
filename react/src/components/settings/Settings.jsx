          ...
          <div className="left">
            ...
            <div className="account-security-item mb-24">
              <div className="heading">
                ...
                <div className="f12-regular text-GrayDark">
                  Identify Verification is an enhanced security measure. Once
              ...
              <div className="content">
                <div className="content-item">
                  ...
                  <div>
                    <div className="mb-6 f12-bold">
                      Manage Identify Verification
                    </div>
                    <div className="f12-regular text-GrayDark">
                      Used for withdrawal &amp; Security verification
                    </div>
          ...
          <div className="right">
            <div className="account-security-item d-block mb-24">
              <div className="content-item mb-24">
                ...
                <a href="#" className="flex-shrink-0 f12-medium">
                  Manage
                </a>
              </div>
              <div className="content-item">
            ...
            <div className="account-security-item d-block mb-24">
              ...
              <div>
                ...
                <a href="#" className="f14-bold text-Salmon">
                  Deactivated Account
                </a>
              </div>
            </div>
