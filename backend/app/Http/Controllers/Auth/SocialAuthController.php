    ...
    public function handleProviderCallback($provider)
    {
        ...
        if ($user) {
            ...
            $user = User::create([
                ...
                'avatar' => $socialUser->getAvatar(),
                'password' => null,
                // Username will be auto-generated by the User model's booted() creating callback
            ]);
        }

// Credit the daily login bonus (only once per day, on actual login).
        $user->creditDailyLoginBonus();
        $user = $user->fresh();
